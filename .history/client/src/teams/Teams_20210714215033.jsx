    ...
    render() {
        return (
            <div className="container row">
                ...
                <div className="card" style={{width: '100%', height: '100%'}}><a href="#"><img className="img-fluid card-img-top" style={{height: '200px'}} src="assets/img/1.jpg" /></a>
                ...
                <div className="col-4 py-3 mx-auto col-xl-4 col-lg-6 col-md-6 col-sm-12" style={{minWidth: '300px', minHeight: '300px'}}>
                <div className="card"><a href="#"><img className="card-img-top" style={{height: '200px'}} src="assets/img/2.jpg" /></a>
                    <div className="card-body">
                ...
                <div className="col-4 py-3 mx-auto col-xl-4 col-lg-6 col-md-6 col-sm-12" style={{minWidth: '300px', minHeight: '300px'}}>
                <div className="card"><a href="#"><img className="card-img-top" style={{height: '200px'}} src="assets/img/3.png" /></a>
                    <div className="card-body">
                ...
                <div className="col-4 py-3 mx-auto col-xl-4 col-lg-6 col-md-6 col-sm-12" style={{minWidth: '300px', minHeight: '300px'}}>
                <div className="card"><a href="#"><img className="card-img-top" style={{height: '200px'}} src="assets/img/4.jpg" /></a>
                    <div className="card-body">
