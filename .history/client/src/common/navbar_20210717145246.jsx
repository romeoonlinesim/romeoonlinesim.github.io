...
class Navbar extends React.Component {
    ...
    LogOutDiv = (obj, show) => {
        return (<div className="dropdown">
            <a id="navbarDropdown" className="welcome dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" area-expanded="false" onClick={this.toggleMenu}>
                Welcome,  {obj.user.username}
            </a>
            <div className={"dropdown-menu float-right" + show} aria-labelledby="navbarDropdown">
