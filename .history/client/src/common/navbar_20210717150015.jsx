...
class Navbar extends React.Component {
    ...
    LogOutDiv = (obj, show) => {
        return (<div className="dropdown">
            <a id="navbarDropdown" className="welcome dropdown-toggle" href="#" onClick={this.toggleMenu}>
                Welcome,  {obj.user.username}
            </a>
            <div className={"dropdown-menu dropdown-menu-right " + show}>
                <NavLink exact to="/" className="dropdown-item" activeClassName="">Profile</NavLink>
                <NavLink exact to="/" className="dropdown-item" activeClassName="">Help and Support</NavLink>
