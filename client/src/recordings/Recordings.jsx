    ...
    return (
        <div className="container">
            ...
            {competitions.map((competition) => {
                ...
                let counter = 1;
                let firstRoundTemp = competition.firstRound.slice(0, competition.firstRound.length);
                let firstRoundResultTemp = competition.firstRoundResult.slice(0, competition.firstRoundResult.length);
                while (firstRoundTemp.length !== 0) {
                    ...
                    firstRound.push(<div className="pb-2">
                ...
                let secondRoundTemp = competition.secondRound.slice(0, competition.secondRound.length);
                let secondRoundResultTemp = competition.secondRoundResult.slice(0, competition.secondRoundResult.length);
                ...
                return (
                    <div className="pb-2 row pt-3">
                        <div>
                            <h2>Competition {competition.index}:
                            <Button
                                variant="link"
                                onClick={() => {
                                    open[competition.index-1] = !open[competition.index-1]; 
                                    console.log(open); 
                                    setOpen([...open]);
                                }}
                                aria-controls={"competition" + competition.index}
